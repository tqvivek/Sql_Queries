...
--
-- Host: localhost    Database: testcourse
-- ------------------------------------------------------
...
INSERT INTO `dept` VALUES (1,'HR'),(2,'FINANCE'),(3,'DEV');
/*!40000 ALTER TABLE `dept` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `deptemp_join`
--

DROP TABLE IF EXISTS `deptemp_join`;
/*!50001 DROP VIEW IF EXISTS `deptemp_join`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `deptemp_join` (
  `DEPTID` tinyint NOT NULL,
  `DEPTNAME` tinyint NOT NULL,
  `EMPID` tinyint NOT NULL,
  `EMPNAME` tinyint NOT NULL
) ENGINE=MyISAM */;
...
CREATE TABLE `employee` (
  ...
  PRIMARY KEY (`ID`),
  KEY `DEP_FOR_ID_idx` (`DEPT_ID`),
  CONSTRAINT `DEP_FOR_ID` FOREIGN KEY (`DEPT_ID`) REFERENCES `dept` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `employee` VALUES (1,'PARIMAL',1),(2,'ANIKET',1),(3,'VIDYABHUSHAN',2),(4,'SHUBHAM',NULL),(5,'PRANAV',NULL);
...
INSERT INTO `foo` VALUES (1,101),(2,102),(3,103),(4,104),(5,101),(6,105);
...
--
-- Dumping events for database 'testcourse'
--

--
-- Dumping routines for database 'testcourse'
--

--
-- Final view structure for view `deptemp_join`
--

/*!50001 DROP TABLE IF EXISTS `deptemp_join`*/;
/*!50001 DROP VIEW IF EXISTS `deptemp_join`*/;
...
/*!50001 VIEW `deptemp_join` AS select `dep`.`ID` AS `DEPTID`,`dep`.`NAME` AS `DEPTNAME`,`emp`.`ID` AS `EMPID`,`emp`.`NAME` AS `EMPNAME` from (`dept` `dep` join `employee` `emp`) where (`dep`.`ID` = `emp`.`DEPT_ID`) */;
...
-- Dump completed on 2017-08-30 19:39:58
